...
type ComplexityRoot struct {
	Mutation struct {
		CreateTodo       func(childComplexity int, todoInput model.CreateTodoInput) int
		DeleteTodo       func(childComplexity int, todoID string) int
		UpdateTodoStatus func(childComplexity int, todoID string, done bool) int
	}
...
type MutationResolver interface {
	CreateTodo(ctx context.Context, todoInput model.CreateTodoInput) (*model.Todo, error)
	UpdateTodoStatus(ctx context.Context, todoID string, done bool) (bool, error)
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Mutation.createTodo":
		...
		return e.complexity.Mutation.CreateTodo(childComplexity, args["todoInput"].(model.CreateTodoInput)), true
	...
	case "Mutation.updateTodoStatus":
		...
		return e.complexity.Mutation.UpdateTodoStatus(childComplexity, args["todoId"].(string), args["done"].(bool)), true
...
var sources = []*ast.Source{
	{Name: "../../schema.graphqls", Input: `# データ取得のためのスキーマ
type Query {
  todos: [Todo!]!
}
...
func (ec *executionContext) field_Mutation_createTodo_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["todoInput"]; ok {
		ctx := graphql.WithPathContext(ctx, graphql.NewPathWithField("todoInput"))
...
func (ec *executionContext) _Mutation_createTodo(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		...
		return ec.resolvers.Mutation().CreateTodo(rctx, fc.Args["todoInput"].(model.CreateTodoInput))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
	...
	fc.Result = res
	return ec.marshalNTodo2ᚖgithubᚗcomᚋtomotakashimizuᚋtodoappᚑgraphqlᚑgoᚑreactᚋappᚋgraphᚋmodelᚐTodo(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Mutation_updateTodoStatus(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().UpdateTodoStatus(rctx, fc.Args["todoId"].(string), fc.Args["done"].(bool))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) marshalNTodo2githubᚗcomᚋtomotakashimizuᚋtodoappᚑgraphqlᚑgoᚑreactᚋappᚋgraphᚋmodelᚐTodo(ctx context.Context, sel ast.SelectionSet, v model.Todo) graphql.Marshaler {
